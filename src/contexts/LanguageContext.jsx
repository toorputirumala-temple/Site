...
export const translations = {
  en: {
    ...
    donate: {
      ...
      scanPay: 'Pay via UPI App / QR',
      amountLabel: 'Amount',
      payViaPaytmBtn: 'Pay via Paytm (Auto-saves QR & Opens Scanner)',
      payViaPhonePeBtn: 'Pay via PhonePe (Auto-saves QR)',
      payViaGPayBtn: 'Pay via Google Pay (Auto-saves QR)',
      saveQr: 'Save QR to Photos / Gallery',
      qrInstructions: 'Scan this QR using PhonePe, Google Pay, Paytm, or BHIM.',
      galleryTip: '💡 Step 1: Tap your app button below (QR auto-saves) ➔ Step 2: In Paytm/PhonePe, tap "Scan" ➔ Step 3: Select saved QR from Gallery to pay.',
  ...
  te: {
    ...
    donate: {
      ...
      scanPay: 'UPI యాప్ / QR ద్వారా చెల్లించండి',
      amountLabel: 'మొత్తం',
      payViaPaytmBtn: 'Paytm ద్వారా చెల్లించండి (QR సేవ్ చేసి స్కానర్ ఓపెన్ అవుతుంది)',
      payViaPhonePeBtn: 'PhonePe ద్వారా చెల్లించండి (QR సేవ్ అవుతుంది)',
      payViaGPayBtn: 'Google Pay ద్వారా చెల్లించండి (QR సేవ్ అవుతుంది)',
      ...
      galleryTip: '💡 దశ 1: క్రింది యాప్ బటన్ నొక్కండి (QR సేవ్ అవుతుంది) ➔ దశ 2: Paytm/PhonePe లో "Scan" నొక్కండి ➔ దశ 3: గ్యాలరీ నుండి QR ఎంచుకుని చెల్లించండి.',
